  ...
  return (
    ...
    '>
      <div className='w-48 h-auto flex item-center justify-center relative md:w-24'>
        <HireSale className={"fill-dark animate-spin-slow dark:fill-light max-w-25"} />

        <Link href="mailto:contact.siplproperties@gmail.com" className='flex items-center justify-center 
