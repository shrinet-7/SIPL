...
const NavBar = () => {
  ...
  return (
    ...
    z-10 xl:px-16 md:px-12 sm:px-8
    '>

      <button aria-label="cdc" className='flex-col justify-center items-center hidden lg:flex' onClick={handleClick}>
      ...
      <div className='w-full flex justify-between items-center lg:hidden'>
        ...
        <nav>
          ...
          <CustomLink href='/articles' title="Inventory" className='mx-4' />
        ...
        <nav className='flex items-center justify-center flex-wrap'>
          ...
          <motion.a href='https://www.youtube.com/@shrinetinfrastructure' target={"_blank"}
            whileHover={{ y: -2 }}
            whileTap={{ scale: 0.9 }}
            className='w-6 ml-3'
          >
...

      {
       ...
       -translate-x-1/2 -translate-y-1/2 bg-dark/90 dark:bg-light/75 rounded-lg backdrop-blur-md py-32'>
            ...
            <nav className='flex items-center flex-col justify-center'>
              ...
              <CustomMobileLink href='/articles' title="Inventory" toggle={handleClick} />
